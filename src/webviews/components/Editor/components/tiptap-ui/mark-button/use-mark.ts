...
// --- Icons ---
import { BoldIcon } from "src/webviews/components/Editor/components/tiptap-icons/bold-icon";
import { Code2Icon } from "src/webviews/components/Editor/components/tiptap-icons/code2-icon";
import { ItalicIcon } from "src/webviews/components/Editor/components/tiptap-icons/italic-icon";
import { StrikeIcon } from "src/webviews/components/Editor/components/tiptap-icons/strike-icon";
import { SubscriptIcon } from "src/webviews/components/Editor/components/tiptap-icons/subscript-icon";
import { SuperscriptIcon } from "src/webviews/components/Editor/components/tiptap-icons/superscript-icon";
import { UnderlineIcon } from "src/webviews/components/Editor/components/tiptap-icons/underline-icon";
