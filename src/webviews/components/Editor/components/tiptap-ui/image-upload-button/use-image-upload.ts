...
// --- Lib ---
import { isExtensionAvailable } from "src/webviews/components/Editor/lib/tiptap-utils";

// --- Icons ---
import { ImagePlusIcon } from "src/webviews/components/Editor/components/tiptap-icons/image-plus-icon";
