...
// --- Icons ---
import { HeadingOneIcon } from "src/webviews/components/Editor/components/tiptap-icons/heading-one-icon";
import { HeadingTwoIcon } from "src/webviews/components/Editor/components/tiptap-icons/heading-two-icon";
import { HeadingThreeIcon } from "src/webviews/components/Editor/components/tiptap-icons/heading-three-icon";
import { HeadingFourIcon } from "src/webviews/components/Editor/components/tiptap-icons/heading-four-icon";
import { HeadingFiveIcon } from "src/webviews/components/Editor/components/tiptap-icons/heading-five-icon";
import { HeadingSixIcon } from "src/webviews/components/Editor/components/tiptap-icons/heading-six-icon";
