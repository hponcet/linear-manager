async function resizeImageFile(file: File, maxSizeInBytes: number): Promise<File> {
...
export async function getImageFileToBase64(file: File, maxSizeInBytes: number): Promise<string> {
  let fileToUse = file
